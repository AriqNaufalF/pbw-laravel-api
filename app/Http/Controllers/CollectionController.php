...
class CollectionController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(CollectionResource::collection($collections), 'Post fetcher');
    }
    ...
    public function store(Request $request)
    {
        ...
        $collections = Collection::create($input);
        return $this->sendResponse(new CollectionResource($collections), 'Post created');
    }
